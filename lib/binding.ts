...
export interface CppBindingAutogen {
  ...
  columnar_client_errc: {
    canceled: CppColumnarClientErrc
    invalid_argument: CppColumnarClientErrc
    cluster_closed: CppColumnarClientErrc
  }
}
...
export interface CppColumnarError extends CppErrorBase {
  ...
  client_err_code?: string
  core_err_code?: string
}
