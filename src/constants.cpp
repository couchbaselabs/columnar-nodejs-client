...
Constants::InitAutogen(Napi::Env env, Napi::Object exports)
{
  ...
  exports.Set("columnar_client_errc",
              cbppEnumToJs<couchbase::core::columnar::client_errc>(
                env,
                {
                  { "canceled", couchbase::core::columnar::client_errc::canceled },
                  { "invalid_argument", couchbase::core::columnar::client_errc::invalid_argument },
                  { "cluster_closed", couchbase::core::columnar::client_errc::cluster_closed },
                }));
